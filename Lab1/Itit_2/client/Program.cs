    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //while (string.IsNullOrEmpty(name))
            {
                ...
                if (logs.Length >= 1023)
                {
                    Console.WriteLine("Sorry. Your login and password very big. Choose another. Advice. Max total length 1023 symbols.");
                    break;
                }
            ...
            while (!string.IsNullOrEmpty((s = Console.ReadLine())))
            {
                ...
                {
                    Console.WriteLine("Sorry. Your message very big. Split. Advice. Max total length 1024 symbols.");
                    break;
                }
